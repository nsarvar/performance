...
class User_ extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('birth_date, created_at', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, login, password, name, organization_id, group_id, email, telephone, mobile, birth_date, picture, status, created_at, role', 'safe', 'on' => 'search'),
        );
    }
