...
<div class="row">
    ...
    <div class="col col-sm-6">
        ...
        <?php echo $form->dropDownListControlGroup($model, 'region_id', Region::getOptionLabels(), array('class' => 'selectpicker show-tick', 'title' => __('Choose Region'))); ?>
...
<p class="pull-right">
    ...
    <button type="submit" name="save"
            class="btn btn-success btn-lg"><?= $model->scenario == 'update' ? __('Update') : __('Create Organization')?></button>
</p>
<?php $this->endWidget(); ?>
